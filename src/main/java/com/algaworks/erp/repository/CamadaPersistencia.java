...
public class CamadaPersistencia {
    ...
    public static void main(String[] args) {
        ...
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("AlgaWorksPU", props);
        ...
        props.put("javax.persistence.jdbc.url", "jdbc:mysql://localhost:3306/cursojsfprimefaces");
        
        emf = Persistence.createEntityManagerFactory("AlgaWorksPU", props);
	...
	public static void exec(EntityManager em) {		
